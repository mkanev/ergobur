...
public class MailConfiguration implements EnvironmentAware {
  ...
  private static final String PROP_MAIL_QUITWAIT = "mail.smtp.quitwait";
  ...
  public JavaMailSenderImpl javaMailSender() {
    ...
    int port = propertyResolver.getProperty(PROP_PORT, Integer.class, DEFAULT_PROP_PORT);
    ...
    Boolean quitwait = propertyResolver.getProperty(PROP_QUITWAIT, Boolean.class, false);
    ...
    sendProperties.setProperty(PROP_MAIL_SMTP_AUTH, auth.toString());
    sendProperties.setProperty(PROP_MAIL_STARTTLS, tls.toString());
    sendProperties.setProperty(PROP_MAIL_QUITWAIT, quitwait.toString());
